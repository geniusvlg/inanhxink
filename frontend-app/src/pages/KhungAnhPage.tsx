            ...
            <div className="khuganh-grid">
              {products.length === 0 && (
                <div className="khuganh-empty">
                  ...
                  <button className="khuganh-reset-btn" onClick={() => handleFilterChange(DEFAULT_FILTERS)}>
                    Đặt lại bộ lọc
                  </button>
                </div>
              )}
                      ...
                      <button
                        ...
                        onClick={e => {
                          ...
                          startBuyNowCheckout({
                            product_id:   p.id,
                            product_name: p.name,
                            unit_price:   getActiveDiscountPrice(p) ?? p.price,
                            quantity:     1,
                            thumbnail:    p.images?.[0] ? resolveUrl(p.images[0]) : undefined,
                          });
